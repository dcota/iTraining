...
Author: Duarte Cota
Date: 2020
Script: NodeJs hardware test deploy route
*/

const express = require("express");
const deployHardRequest = express.Router();
const app = express();



const deployRequestCollection = require("../models/DeployHardRequest")

deployHardRequest.post("/", (req,res) => {
    ...
    .then ((data) => {
        ...
        var obj = {"deployURL":"http://localhost:5000/deployhardconfig/?inveniraStdID=" + req.body.inveniraStdID + "&activityID=" + req.body.activityID }
        res.json(obj);
    })
    .catch ((error) => {
        console.log(error);
...
deployHardRequest.get("/:inveniraStdID/:activityID", (req,res) => {
...
module.exports = deployHardRequest;